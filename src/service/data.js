...
// export const getAvailableShifts = async (token) => {
//   const res = await fetch(`${API_BASE_URL}/dsp/available-shifts`, {
//     method: "GET",
//     headers: { Authorization: `Bearer ${token}` },
//   });
//   if (!res.ok) {
...
//     headers: { Authorization: `Bearer ${token}` },
//   });
//   if (!res.ok) throw new Error((await res.json()).message || "Failed to fetch trainer stats");
//   return res.json();
// };

// export const getCourseAnalytics = async (token, courseId) => {
//   const res = await fetch(`${API_BASE_URL}/trainer/analytics/${courseId}`, {
//     method: "GET",
//     headers: { Authorization: `Bearer ${token}` },
//   });
//   if (!res.ok) throw new Error((await res.json()).message || "Failed to fetch course analytics");
//   return res.json();
// };

// export const getStudentProgress = async (token, courseId) => {
//   const res = await fetch(`${API_BASE_URL}/trainer/progress/${courseId}`, {
//     method: "GET",
//     headers: { Authorization: `Bearer ${token}` },
//   });
//   if (!res.ok) throw new Error((await res.json()).message || "Failed to fetch student progress");
//   return res.json();
// };

// export const getRevenueAnalytics = async (token) => {
//   const res = await fetch(`${API_BASE_URL}/trainer/revenue`, {
//     method: "GET",
//     headers: { Authorization: `Bearer ${token}` },
//   });
//   if (!res.ok) throw new Error((await res.json()).message || "Failed to fetch revenue analytics");
//   return res.json();
// };
// // Messaging Endpoints
